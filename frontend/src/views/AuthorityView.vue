    ...
    <article class="container">
      ...
      <div class="form-box" id="form-box">
        <form action="" class="form form_signin" method="post">
          ...
          <p>
            <input type="text" class="form__input" name="" placeholder="Username" />
          </p>
          ...
          <p>
            <input class="form__btn" type="submit" name="" value="Sign In" />
          </p>
        </form>
        ...
        <form action="" class="form form_signup" method="post">
          ...
          <p>
            <input type="text" name="" class="form__input" placeholder="Username" />
          </p>
          <p>
            <input type="email" name="" class="form__input" placeholder="Your email" />
          </p>
          <p class="password__toggle">
            <input type="password" name="" id="repeat__password" class="form__input" placeholder="Password" />
            <svg class="toggle__icon_signup" id="repeat__icon" @click="togglePasswordRepeat">
              <use xlink:href="#eye"></use>
            </svg>
          </p>
          <p>
            <input type="password" name="" id="repeat__password_double" class="form__input"
              placeholder="Repeat password" />
          </p>
          <p>
            <input type="submit" class="form__btn form__btn_signup" name="" value="Sign Up" />
          </p>
        </form>
      </div>
